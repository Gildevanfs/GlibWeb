...
if ((!isset($_SESSION['email']) == true) and (!isset($_SESSION['email']) == true))
  ...
  $sql = "SELECT * FROM cad_pessoa ORDER BY id_pessoa DESC;";
...
<div class="formCadUsuario">
        <form class="formUsuario" action="" method="POST">
            <h1 class="tituloPage">Consulta de Usuários</h1>   
            <hr>
        ...
        <tbody>
            ...
            href='edita_usuario.php?id=$user_data[id_pessoa]' //ENVIA PARA A TELA DE EDITA CLIENTE O ID - COD_CLIENTE.
            >
            ...
            <a class='btn btn-sm btn-outline-danger' href='delete_usuario.php?id=$user_data[id_pessoa]'> 
