...
if ((!isset($_SESSION['email']) == true) and (!isset($_SESSION['senha']) == true))
    ...
    $sql = "SELECT * FROM cad_produto ORDER BY cod_produto DESC";
...
<div class="formCadUsuario">
        <form class="formUsuario" action="" method="POST">
            <h1 class="tituloPage">Consulta de Produtos</h1>   
            <hr>
        ...
        <tbody>
            ...
            echo "<td>".$user_data['desc_produto']."</td>";
            echo "<td>".$user_data['preco_produto']."</td>";
            echo "<td>".$user_data['cod_barras']."</td>";
            echo "<td>".$user_data['vida_util']."</td>";
            echo "<td> 
                    <a class = 'btn btn-sm btn-outline-secondary' 
                    href='edita_produto.php?id=$user_data[cod_produto]' //ENVIA PARA A TELA DE EDITA produto O ID - COD_PRODUTO.
                    > 
                    ...
                    <a class='btn btn-sm btn-outline-danger' href='delete_produto.php?id=$user_data[cod_produto]'> 
